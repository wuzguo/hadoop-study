...
object Parameters {
    ...
    // Socket
    val SOCKET_PORT: Param[Integer] = Param.integer("socket-port", 9900)
    val SOCKET_HOST: Param[String] = Param.string("socket-host", "10.20.0.92")
    ...
    val RECORDS_PER_SECOND: Param[Integer] = Param.integer("records-per-second", 1)
