 ...
 * Date 工具类
 * <p>
 * 0、不使用SimpleDateFormat(创建开销大,线程不安全) 1、FastDateFormat 是线程安全的format对象,FastDateFormat支持全局缓存，效率比ThreadLocal方案高
 * 2、默认TimeZone是东八区 3、日期计算推荐LocalDate LocalTime对象, 避免使用可变的Calendar对象
 */
