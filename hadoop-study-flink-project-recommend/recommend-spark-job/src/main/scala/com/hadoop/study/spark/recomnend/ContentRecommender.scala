...
import com.hadoop.study.spark.recomnend.beans.{ProductRecs, Recommendation}
...
object ContentRecommender {
    ...
    val CONTENT_PRODUCT_RECS = "content_product_recs"
    ...
    def main(args: Array[String]): Unit = {
        ...
        val productTagsDF = spark.read
          ...
          .load()
          .as[com.hadoop.study.spark.recomnend.beans.Product]
